...
with tabs[1]:
    ...
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("This graph highlights how small changes in the strong nuclear force multiplier destabilize or stabilize heavy isotopes, impacting the island of stability.")
...
with tabs[2]:
    ...
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Star formation depends on balancing gravity and dark energy. This surface graph shows conditions under which stars are likely to form.")
...
with tabs[3]:
    ...
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Life viability is based on the probability of complex chemistry arising from balanced strong and electromagnetic forces. This heatmap predicts likely life-supporting scenarios.")
...
with tabs[4]:
    ...
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Chemical bonding depends on nuclear and electromagnetic interactions. This surface graph shows how these affect bonding probabilities.")
...
with tabs[5]:
    ...
    st.pyplot(fig)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Deviation from fundamental constants reduces universe viability. This simple bar graph shows overall universe likelihood of stability.")
...
with tabs[6]:
    ...
    st.pyplot(fig)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Nuclear force levels impact element synthesis during stellar nucleosynthesis. This graph shows abundance shifts driven by constants.")
...
with tabs[7]:
    ...
    st.pyplot(fig)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("The electromagnetic force multiplier affects radiation damage potential. Higher values increase radiation hazards to matter and life.")
...
with tabs[8]:
    ...
    st.pyplot(fig)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("Gravitational intensity determines how long stars burn. This graph shows stellar lifespan variations based on gravity multiplier.")
...
with tabs[9]:
    ...
    st.pyplot(fig)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("This 2D simulation shows random dark matter density fluctuations that shape galaxy formation and cosmic structure.")
...
with tabs[10]:
    ...
    st.plotly_chart(fig, use_container_width=True)
    st.markdown("### AI Analysis — Scientific Interpretation")
    st.markdown("This 3D scatter graph shows stability of isotopes based on strong, electromagnetic, and weak forces impacting nuclear binding.")
